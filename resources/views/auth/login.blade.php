...
<head>
  ...
  <title>Login &mdash; EventMS</title>
      <!-- Tailwind CSS -->
...
<div class="side">
  ...
  <!-- LEFT PANEL: monkey mascot + branding -->
  <div class="left-panel">
    ...
    <div class="brand">
      ...
      <p>Plan smarter, manage better, celebrate more.</p>
    </div>
  ...
  <div class="right-panel">
    ...
    <form action="/login" method="POST">
      ...
      <div class="field">
        ...
        <div class="input-wrap">
          ...
          <button type="button" class="eye-toggle" id="toggle-pw"
    ...
    <p class="register-link">
      ...
      <a href="<?php echo route('register'); ?>">Create one free</a>
    </p>

  </div>
</div>

<!-- Monkey animation script (loaded after DOM) -->
